...
static std::map<std::string, service> services = {
  ...
  { "uiPlan", {"uiPlan", 8056, true, 20, 40}},
  { "qRoadEncodeIdx", {"qRoadEncodeIdx", 8057, false, 20, -1}},
  { "userFlag", {"userFlag", 8058, true, 0, 1}},
  { "microphone", {"microphone", 8059, true, 10, 10}},
  { "uiDebug", {"uiDebug", 8060, true, 0, 1}},
  { "testJoystick", {"testJoystick", 8061, true, 0, -1}},
  { "roadEncodeData", {"roadEncodeData", 8062, false, 20, -1}},
  { "driverEncodeData", {"driverEncodeData", 8063, false, 20, -1}},
  { "wideRoadEncodeData", {"wideRoadEncodeData", 8064, false, 20, -1}},
  { "qRoadEncodeData", {"qRoadEncodeData", 8065, false, 20, -1}},
  { "livestreamWideRoadEncodeIdx", {"livestreamWideRoadEncodeIdx", 8066, false, 20, -1}},
  { "livestreamRoadEncodeIdx", {"livestreamRoadEncodeIdx", 8067, false, 20, -1}},
  { "livestreamDriverEncodeIdx", {"livestreamDriverEncodeIdx", 8068, false, 20, -1}},
  { "livestreamWideRoadEncodeData", {"livestreamWideRoadEncodeData", 8069, false, 20, -1}},
  { "livestreamRoadEncodeData", {"livestreamRoadEncodeData", 8070, false, 20, -1}},
  { "livestreamDriverEncodeData", {"livestreamDriverEncodeData", 8071, false, 20, -1}},
  { "customReservedRawData0", {"customReservedRawData0", 8072, true, 0, -1}},
  { "customReservedRawData1", {"customReservedRawData1", 8073, true, 0, -1}},
  { "customReservedRawData2", {"customReservedRawData2", 8074, true, 0, -1}},
};
#endif
