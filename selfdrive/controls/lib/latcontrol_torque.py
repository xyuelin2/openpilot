...
class LatControlTorque(LatControl):
  def __init__(self, CP, CI):
    ...
    self.CP = CP # Needed to get updates
  ...
  def detectChange(self):
    ...
    if not math.isclose(self.kf, self.CP.lateralTuning.torque.kf):
      self.friction = self.CP.lateralTuning.torque.friction
      
    if not math.isclose(self.steering_angle_deadzone_deg, self.CP.lateralTuning.torque.steeringAngleDeadzoneDeg):
