...
CAR_INFO: Dict[str, Union[GMCarInfo, List[GMCarInfo]]] = {
  ...
  CAR.TAHOE: [
    GMCarInfo("Chevrolet Tahoe 2016-20", "LTZ/Premier Trim"),
    GMCarInfo("GMC Yukon 2016-20", "LTZ/Premier Trim"),
  ]
}
...
CAMERA_ACC_CAR = {CAR.BOLT_EUV, CAR.SILVERADO, CAR.EQUINOX, CAR.TAHOE}
